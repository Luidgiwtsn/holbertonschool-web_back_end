...
const countStudents = (path) => new Promise((resolve, reject) => {
  //  Utilisation de fs.readFile (Non-bloquant)
  ...
  fs.readFile(path, 'utf8', (err, data) => {
    ...
    //  Initialisation des compteurs et du dictionnaire d'étudiants
    const students = {};
    let totalStudents = 0;
    ...
    //  Affichage des statistiques sur la sortie standard (STDOUT)
